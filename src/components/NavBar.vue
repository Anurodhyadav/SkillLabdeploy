      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <div class="nav-item dropdown">
          <a
            ...
            aria-expanded="false"
          >
            <span class="navEmail" v-if="user_PhotoUrl === null">{{ current_User_email }}</span>
            <img v-else class="navimg" v-bind:src="user_PhotoUrl" width="30" height="30" />
          </a>
          <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
            <div class="card text-white">
              <span class="navEmail" v-if="user_PhotoUrl === null"></span>
              <img v-else class="dropdnimg" v-bind:src="user_PhotoUrl" width="90" height="90" />
