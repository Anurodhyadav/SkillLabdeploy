<template>
  <div>
    ...
    <vs-popup class="popup" title="About" :active.sync="aboutPop">
      <p>
        SKILL LAB, an initiative to connect industry based knowledge, skills and competencies to
        Academic Institutions in Nepal and also function as Career Pathways for the undergraduate
        students enhancing employability outcomes.
      </p>
    </vs-popup>
