                ...
                <vs-col vs-type="flex" vs-justify="center" vs-align="center" vs-w="4.5">
                    <vs-card>
                        ...
                        <div>
                            <span>
                                <ul class="list">
                                    <li v-if="hiddenstudentCount === 0">
                                        Hidden Students: No students hidden yet
                                    </li>
                                    <li v-else>Hidden Students: {{ hiddenstudentCount }}</li>
                                </ul>
                            </span>
                        </div>
                        <div slot="footer">
            ...
            <vs-row vs-type="flex" vs-justify="space-around">
                ...
                <vs-col type="flex" vs-justify="center" vs-align="center" vs-w="4.5">
                    <vs-card>
                        ...
                        <div slot="footer">
                            <vs-row vs-justify="space-around">
                                <vs-button
                                    color="primary"
                                    icon="cloud_download"
                                    @click="toggleAudioDumper"
                                    >Export Data</vs-button
                                >
                                <vs-button type="gradient" color="danger" href="/#/upload"
                                    >Add Audio</vs-button
                                >
                        ...
                        <AudioDump
                            :isActive="isAudioDumperVisible"
                            @closing="toggleAudioDumper"
                        ></AudioDump>
                    </vs-card>
                </vs-col>
                <!-- feedback card -->
            ...
            <vs-row vs-type="flex" vs-justify="space-around">
                ...
                >
                    <vs-card>
                        ...
                        <div slot="footer">
                            <vs-row vs-justify="flex-end">
                                <vs-button type="gradient" color="danger" href="/#/adminregister"
                                    >Manage</vs-button
                                >
                            </vs-row>
                        </div>
